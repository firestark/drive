...
var $author$project$Main$AddQuest = function (a) {
	return {$: 'AddQuest', a: a};
};
...
var $author$project$Route$QuestList = {$: 'QuestList'};
...
var $author$project$Page$Login$init = F2(
	function (key, theme) {
		return {
			form: A2($author$project$Page$Login$Form, '', ''),
			key: key,
			problems: _List_Nil,
			showPassword: false,
			showSnackbar: false,
...
var $author$project$Page$Quest$List$GotQuestCompletions = function (a) {
	return {$: 'GotQuestCompletions', a: a};
};
var $author$project$Api$Endpoint$completedToday = A2(
	$author$project$Api$Endpoint$url,
	_List_fromArray(
		['completions', 'today']),
	_List_Nil);
var $author$project$Completion$Completion = F2(
	function (title, completedAt) {
		return {completedAt: completedAt, title: title};
	});
var $author$project$Completion$itemDecoder = A3(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'completedAt',
	$elm$json$Json$Decode$int,
	A3(
		...
		'title',
		$elm$json$Json$Decode$string,
		$elm$json$Json$Decode$succeed($author$project$Completion$Completion)));
var $author$project$Completion$decoder = $elm$json$Json$Decode$list($author$project$Completion$itemDecoder);
var $author$project$Page$Quest$List$request2 = function (cred) {
	return A4(
		$author$project$Api$get,
		$author$project$Api$Endpoint$completedToday,
		$elm$core$Maybe$Just(cred),
		$author$project$Page$Quest$List$GotQuestCompletions,
		$author$project$Completion$decoder);
};
var $author$project$Page$Quest$List$init = F3(
	function (snackbarTxt, cred, theme) {
		return _Utils_Tuple2(
			{
				completions: $krisajenkins$remotedata$RemoteData$NotAsked,
				cred: cred,
			...
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						...
						$author$project$Page$Quest$List$request2(cred),
						function () {
						if (snackbarTxt.$ === 'Just') {
					...
					case 'AddQuest':
						...
						return _Utils_Tuple2(
							A2(
								...
								session,
								$author$project$Main$AddQuest(subModel)),
							$elm$core$Platform$Cmd$none);
					case 'Completions':
					...
					case 'Logout':
						...
						var _v5 = A2(
							...
							$author$project$Main$Unauthenticated(
								A2($author$project$Page$Login$init, session.key, session.theme)));
						var newModel = _v5.a;
						return _Utils_Tuple2(newModel, $author$project$Api$logout);
					default:
						var _v6 = maybeRoute.a;
						var _v7 = A3($author$project$Page$Quest$List$init, session.snackbar, session.cred, session.theme);
						var subModel = _v7.a;
						var cmd = _v7.b;
						return _Utils_Tuple2(
							A2(
								$author$project$Main$Authenticated,
								session,
								$author$project$Main$QuestList(subModel)),
							A2($elm$core$Platform$Cmd$map, $author$project$Main$GotQuestListMsg, cmd));
				}
			}
		} else {
			return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
...
var $author$project$Route$AddQuest = {$: 'AddQuest'};
var $author$project$Route$Completions = {$: 'Completions'};
...
var $author$project$Route$parser = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			A2($elm$url$Url$Parser$map, $author$project$Route$QuestList, $elm$url$Url$Parser$top),
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Route$AddQuest,
			$elm$url$Url$Parser$s('add')),
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Route$Completions,
			$elm$url$Url$Parser$s('completions')),
			A2(
			$elm$url$Url$Parser$map,
	...
	function (maybeViewer, url, navKey) {
		...
		if (maybeViewer.$ === 'Just') {
			...
			return A2(
				...
				$author$project$Route$fromUrl(url),
				$author$project$Main$Unauthenticated(
					A2($author$project$Page$Login$init, navKey, theme)));
		}
	});
...
var $author$project$Main$GotAddQuestMsg = function (a) {
	return {$: 'GotAddQuestMsg', a: a};
};
					...
					$elm$json$Json$Encode$object(
						_List_fromArray(
							[
								_Utils_Tuple2(
								'username',
								$author$project$Username$encode(name)),
								_Utils_Tuple2(
								'token',
...
var $author$project$Page$Login$validateField = F2(
	function (_v0, field) {
		...
		return A2(
			...
			function () {
				if (field.$ === 'Name') {
					return $elm$core$String$isEmpty(form.name) ? _List_fromArray(
			...
			switch (msg.$) {
				case 'CompletedLogin':
					if (msg.a.$ === 'Err') {
						...
						var $temp$msg = $author$project$Page$Login$ShowSnackbar,
							$temp$model = newModel;
						msg = $temp$msg;
						model = $temp$model;
						continue update;
				...
				case 'ShowSnackbar':
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{showSnackbar: true}),
						A2($author$project$Page$Login$delay, 5000, $author$project$Page$Login$HideSnackbar));
				default:
	...
	function (msg, model) {
		...
		while (true) {
			switch (_v0.b.$) {
				case 'LinkClicked':
					if (_v0.a.$ === 'Authenticated') {
						...
						if (urlRequest.$ === 'Internal') {
							...
							return _Utils_Tuple2(
								A2($author$project$Main$Authenticated, session, page),
								A2(
				...
				case 'GotAddQuestMsg':
					if ((_v0.a.$ === 'Authenticated') && (_v0.a.b.$ === 'AddQuest')) {
						var _v3 = _v0.a;
						var session = _v3.a;
						var page = _v3.b.a;
						var subMsg = _v0.b.a;
					...
					if ((_v0.a.$ === 'Authenticated') && (_v0.a.b.$ === 'QuestList')) {
						...
						return _Utils_Tuple2(
							A2(
								$author$project$Main$Authenticated,
								session,
								$author$project$Main$QuestList(updatedModel)),
							A2($elm$core$Platform$Cmd$map, $author$project$Main$GotQuestListMsg, cmd));
					} else {
						break _v0$6;
					}
						...
						if (maybeViewer.$ === 'Just') {
							...
							return _Utils_Tuple2(
								...
								A2(
									$elm$browser$Browser$Navigation$pushUrl,
									loginModel.key,
									$author$project$Route$toString($author$project$Route$QuestList)));
						} else {
							return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
						}
					} else {
...
var $author$project$Page$Login$EnteredName = function (a) {
...
var $author$project$Material$Icons$account_circle = $mdgriffith$elm_ui$Element$html(
	A2(
		$elm$svg$Svg$svg,
		_List_fromArray(
			[
...
var $author$project$Page$Login$inputError = F2(
	function (theme, problem) {
		return A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$Font$color(theme.error),
...
var $author$project$Page$Login$isFieldError = F2(
	function (field, problem) {
		if (problem.$ === 'InvalidEntry') {
			var invalidField = problem.a;
			return _Utils_eq(invalidField, field);
		} else {
			return false;
		}
	});
var $author$project$Page$Login$viewFieldErrors = F3(
	function (theme, field, problems) {
		var error = $elm$core$List$head(
			A2(
				$elm$core$List$filter,
				$author$project$Page$Login$isFieldError(field),
				problems));
		if ((error.$ === 'Just') && (error.a.$ === 'InvalidEntry')) {
			var _v1 = error.a;
			var problem = _v1.b;
			return A2($author$project$Page$Login$inputError, theme, problem);
		} else {
			return A2($author$project$Page$Login$inputError, theme, '');
		}
	});
var $author$project$Page$Login$inputName = function (model) {
	return A2(
		...
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								A2($author$project$Theme$highlight, model.theme.kind, 0.54))
							]),
						$author$project$Material$Icons$account_circle),
						A2(
							...
							]),
						{
							...
							onChange: $author$project$Page$Login$EnteredName,
				...
				A3($author$project$Page$Login$viewFieldErrors, model.theme, $author$project$Page$Login$Name, model.problems)
			]));
};
var $author$project$Page$Login$EnteredPassword = function (a) {
	return {$: 'EnteredPassword', a: a};
};
var $author$project$Page$Login$ShowPasswordToggled = {$: 'ShowPasswordToggled'};
var $author$project$Material$Icons$lock = $mdgriffith$elm_ui$Element$html(
	A2(
		$elm$svg$Svg$svg,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$d('M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zm-6 9c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm3.1-9H8.9V6c0-1.71 1.39-3.1 3.1-3.1 1.71 0 3.1 1.39 3.1 3.1v2z')
					]),
				_List_Nil)
			])));
...
var $author$project$Material$Icons$visibility = $mdgriffith$elm_ui$Element$html(
	A2(
		$elm$svg$Svg$svg,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Material$Icons$lock),
						A2(
						...
						{
							label: $mdgriffith$elm_ui$Element$Input$labelHidden(''),
							onChange: $author$project$Page$Login$EnteredPassword,
							placeholder: $elm$core$Maybe$Just(
								A2(
									$mdgriffith$elm_ui$Element$Input$placeholder,
									_List_fromArray(
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$Font$color(
								A2($author$project$Theme$highlight, model.theme.kind, 0.54)),
								$mdgriffith$elm_ui$Element$Events$onClick($author$project$Page$Login$ShowPasswordToggled)
							]),
						$author$project$Material$Icons$visibility)
					])),
				A3($author$project$Page$Login$viewFieldErrors, model.theme, $author$project$Page$Login$Password, model.problems)
			]));
};
...
var $author$project$Page$Login$loginButton = function (theme) {
	return A2(
			...
			]),
		{
			...
			onPress: $elm$core$Maybe$Just($author$project$Page$Login$SubmittedForm)
		});
};
var $mdgriffith$elm_ui$Element$none = $mdgriffith$elm_ui$Internal$Model$Empty;
var $author$project$Material$Elevation$z5 = $mdgriffith$elm_ui$Element$htmlAttribute(
	A2($elm$html$Html$Attributes$style, 'box-shadow', '0 3px 5px -1px rgba(0,0,0,.2), 0 5px 8px 0 rgba(0,0,0,.14), 0 1px 14px 0 rgba(0,0,0,.12)'));
var $author$project$Page$Login$snackbar = A2(
	$mdgriffith$elm_ui$Element$column,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$text('Login failed, wrong credentials.')
				]))
		]));
var $author$project$Page$Login$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				A2($mdgriffith$elm_ui$Element$paddingXY, 24, 80),
				$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
				$mdgriffith$elm_ui$Element$spacing(16),
				$mdgriffith$elm_ui$Element$alignBottom,
				$mdgriffith$elm_ui$Element$inFront(
				model.showSnackbar ? $author$project$Page$Login$snackbar : $mdgriffith$elm_ui$Element$none)
			]),
		_List_fromArray(
			[
				$author$project$Page$Login$inputName(model),
				$author$project$Page$Login$inputPassword(model),
...
var $author$project$Material$Fab$regular = F2(
	function (theme, icon) {
		return A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$Background$color(
										A4($mdgriffith$elm_ui$Element$rgba255, 255, 255, 255, 0.14))
									]))
							]),
						$mdgriffith$elm_ui$Element$text('')))
				]),
...
var $author$project$Page$Quest$Add$isFieldError = F2(
	function (field, problem) {
		if (problem.$ === 'InvalidEntry') {
			var invalidField = problem.a;
			return _Utils_eq(invalidField, field);
...
var $author$project$Page$Quest$Add$viewFieldErrors = F3(
	function (theme, field, problems) {
		var error = $elm$core$List$head(
			A2(
				$elm$core$List$filter,
				$author$project$Page$Quest$Add$isFieldError(field),
				problems));
		if ((error.$ === 'Just') && (error.a.$ === 'InvalidEntry')) {
			var _v1 = error.a;
			var problem = _v1.b;
			return A2($author$project$Page$Quest$Add$inputError, theme, problem);
		} else {
			return A2($author$project$Page$Quest$Add$inputError, theme, '');
		}
	});
var $author$project$Page$Quest$Add$inputCategory = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						{
							label: $mdgriffith$elm_ui$Element$Input$labelHidden(''),
							onChange: $author$project$Page$Quest$Add$EnteredCategory,
							placeholder: $elm$core$Maybe$Just(
								A2(
									$mdgriffith$elm_ui$Element$Input$placeholder,
									_List_fromArray(
...
var $author$project$Page$Quest$Add$inputDescription = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						{
							label: $mdgriffith$elm_ui$Element$Input$labelHidden(''),
							onChange: $author$project$Page$Quest$Add$EnteredDescription,
							placeholder: $elm$core$Maybe$Just(
								A2(
									$mdgriffith$elm_ui$Element$Input$placeholder,
									_List_fromArray(
...
var $author$project$Page$Quest$Add$EnteredMoreInfo = function (a) {
	return {$: 'EnteredMoreInfo', a: a};
};
var $author$project$Page$Quest$Add$MoreInfo = {$: 'MoreInfo'};
...
var $author$project$Page$Quest$Add$inputMoreInfo = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						{
							label: $mdgriffith$elm_ui$Element$Input$labelHidden(''),
							onChange: $author$project$Page$Quest$Add$EnteredMoreInfo,
							placeholder: $elm$core$Maybe$Just(
								A2(
									$mdgriffith$elm_ui$Element$Input$placeholder,
									_List_fromArray(
			...
			[
				...
				_List_fromArray(
					[
						...
						{
							label: $mdgriffith$elm_ui$Element$Input$labelHidden(''),
							onChange: $author$project$Page$Quest$Add$EnteredTitle,
							placeholder: $elm$core$Maybe$Just(
								A2(
									$mdgriffith$elm_ui$Element$Input$placeholder,
									_List_fromArray(
				...
				A3($author$project$Page$Quest$Add$viewFieldErrors, model.theme, $author$project$Page$Quest$Add$Title, model.problems)
			]));
};
...
var $author$project$Material$Icons$arrow_back = $mdgriffith$elm_ui$Element$html(
	A2(
		$elm$svg$Svg$svg,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$d('M19 11H7.83l4.88-4.88c.39-.39.39-1.03 0-1.42-.39-.39-1.02-.39-1.41 0l-6.59 6.59c-.39.39-.39 1.02 \r\n                    0 1.41l6.59 6.59c.39.39 1.02.39 1.41 \r\n                    0 .39-.39.39-1.02 0-1.41L7.83 13H19c.55 0 1-.45 1-1s-.45-1-1-1z')
					]),
				_List_Nil)
			])));
...
var $author$project$Material$Elevation$z2 = $mdgriffith$elm_ui$Element$htmlAttribute(
	A2($elm$html$Html$Attributes$style, 'box-shadow', '0 3px 1px -2px rgba(0,0,0,.2), 0 2px 2px 0 rgba(0,0,0,.14), 0 1px 5px 0 rgba(0,0,0,.12)'));
var $author$project$Page$Quest$Add$topAppBar = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				A3(
				$author$project$Page$Quest$Add$topAppBarRow,
				model.theme,
				_List_Nil,
				_List_fromArray(
					[
...
var $author$project$Page$Quest$Add$view = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
				...
				$author$project$Page$Quest$Add$fab(model.theme))
			]),
		_List_fromArray(
			[
				$author$project$Page$Quest$Add$topAppBar(model),
				A2(
				$mdgriffith$elm_ui$Element$column,
				_List_fromArray(
					[
						...
						{bottom: 72, left: 16, right: 16, top: 16}),
						$mdgriffith$elm_ui$Element$spacing(16)
					]),
				_List_fromArray(
					[
...
var $author$project$Page$Quest$List$MenuClosed = {$: 'MenuClosed'};
var $author$project$Page$Quest$List$filter = F2(
	function (text, quest) {
		return A2($elm$core$String$contains, text, quest.title) ? true : (A2($elm$core$String$contains, text, quest.description) ? true : (A2($elm$core$String$contains, text, quest.category) ? true : (A2($elm$core$String$contains, text, quest.timeEstimate) ? true : A2($elm$core$String$contains, text, quest.moreInfo))));
	});
var $author$project$Page$Quest$List$listDividerTitle = F2(
...
var $author$project$Page$Quest$List$OpenDialog = F2(
	function (a, b) {
			...
			A2(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$px(40)),
						$mdgriffith$elm_ui$Element$Font$color(
						A2($author$project$Theme$highlight, theme.kind, 0.44)),
						$mdgriffith$elm_ui$Element$Background$color(
						A2($author$project$Theme$highlight, theme.kind, 0.1)),
						$mdgriffith$elm_ui$Element$Border$rounded(50),
						$mdgriffith$elm_ui$Element$clip
					]),
				attrs),
...
var $author$project$Material$Icons$info = $mdgriffith$elm_ui$Element$html(
	A2(
		$elm$svg$Svg$svg,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$d('M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z')
					]),
				_List_Nil)
			])));
...
var $author$project$Page$Quest$List$threeElement = F2(
	function (theme, quest) {
		return A2(
			...
			_List_fromArray(
				[
					A3($author$project$Page$Quest$List$icon, theme, _List_Nil, $author$project$Material$Icons$check),
					A2(
					$mdgriffith$elm_ui$Element$row,
					_List_fromArray(
						[
						...
						[
								...
								[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[$mdgriffith$elm_ui$Element$centerY]),
											$mdgriffith$elm_ui$Element$text(quest.title))
										])),
									A2(
									$mdgriffith$elm_ui$Element$row,
									_List_fromArray(
									...
									_List_fromArray(
										[
											...
											A2(
												...
												_List_fromArray(
													[
														$mdgriffith$elm_ui$Element$text(quest.description)
													])))
										]))
								])),
							A2(
							...
							_List_fromArray(
								[
									$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
									$mdgriffith$elm_ui$Element$paddingEach(
									{bottom: 8, left: 0, right: 16, top: 16})
								]),
							_List_fromArray(
								[
									...
									$mdgriffith$elm_ui$Element$text(quest.timeEstimate))
								]))
						]))
				]));
	});
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$paddingEach(
					{bottom: 8, left: 16, right: 0, top: 8})
				]),
			A2(
				$elm$core$List$map,
...
var $author$project$Page$Quest$List$list = F2(
	function (theme, _v0) {
		...
		return A2(
			...
			_List_fromArray(
				[
					A2($author$project$Page$Quest$List$listDividerTitle, theme, category),
					A2($author$project$Page$Quest$List$threeLine, theme, quests)
				]));
	});
...
var $author$project$Page$Quest$List$data = function (model) {
	var _v0 = model.questList;
	switch (_v0.$) {
		case 'NotAsked':
			return _List_fromArray(
				[
					$mdgriffith$elm_ui$Element$text('You didnt ask me so i will do nothing')
				]);
		case 'Loading':
			return _List_fromArray(
				[
		...
		default:
			...
			switch (error.$) {
				case 'BadBody':
					...
					return _List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text('The server responded with something unexpected. Reason: ' + explanation)
						]);
				case 'BadUrl':
					return _List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text('Invalid url')
						]);
				case 'BadStatus':
					var statusCode = error.a;
					return _List_fromArray(
				...
				case 'NetworkError':
					return _List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text('Unable to reach server.')
						]);
				default:
					return _List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text('Server is taking too long to respond. Please try again later.')
						]);
			}
	}
};
	...
	return A2(
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$alignBottom,
				$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
				A2($mdgriffith$elm_ui$Element$paddingXY, 8, 80)
			]),
		_List_fromArray(
			[
				A2(
...
var $author$project$Page$Quest$List$MenuToggled = {$: 'MenuToggled'};
...
var $author$project$Page$Quest$List$menuItem = F3(
	function (theme, route, txt) {
		return A2(
			$mdgriffith$elm_ui$Element$link,
			_List_fromArray(
				[
...
var $author$project$Material$Elevation$z8 = $mdgriffith$elm_ui$Element$htmlAttribute(
...
var $author$project$Page$Quest$List$menu = function (theme) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$alignRight,
				$mdgriffith$elm_ui$Element$Font$size(16),
				$mdgriffith$elm_ui$Element$Font$color(theme.onSurface),
				A2($mdgriffith$elm_ui$Element$paddingXY, 0, 8),
				$mdgriffith$elm_ui$Element$Border$rounded(4),
		...
		_List_fromArray(
			[
				A3($author$project$Page$Quest$List$menuItem, theme, $author$project$Route$Completions, 'My completions'),
				A3($author$project$Page$Quest$List$menuItem, theme, $author$project$Route$Logout, 'Logout')
			]));
};
var $author$project$Material$Icons$search = $mdgriffith$elm_ui$Element$html(
	A2(
		$elm$svg$Svg$svg,
		_List_fromArray(
			[
...
var $author$project$Page$Quest$List$input = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$author$project$Material$Icons$search),
				A2(
				$mdgriffith$elm_ui$Element$Input$text,
				_List_fromArray(
					[
				...
				{
					label: $mdgriffith$elm_ui$Element$Input$labelHidden(''),
					onChange: $author$project$Page$Quest$List$UpdateSearch,
					placeholder: $elm$core$Maybe$Just(
						A2(
							$mdgriffith$elm_ui$Element$Input$placeholder,
							_List_fromArray(
				...
				_List_fromArray(
					[
						...
						A4($mdgriffith$elm_ui$Element$rgba255, 0, 0, 0, 0.54)),
						$mdgriffith$elm_ui$Element$pointer,
						$mdgriffith$elm_ui$Element$Events$onClick($author$project$Page$Quest$List$MenuToggled),
						model.menuOpen ? $mdgriffith$elm_ui$Element$below(
						$author$project$Page$Quest$List$menu(model.theme)) : $mdgriffith$elm_ui$Element$below($mdgriffith$elm_ui$Element$none)
					]),
				$author$project$Material$Icons$account_circle)
			]));
};
var $author$project$Page$Quest$List$questCompletionCount = function (model) {
	var _v0 = model.completions;
	if (_v0.$ === 'Success') {
		var completionList = _v0.a;
		return $elm$core$List$length(completionList);
	} else {
		return 0;
	}
};
var $author$project$Page$Quest$List$topAppBarRow = F3(
	function (theme, attributes, elements) {
		return A2(
			$mdgriffith$elm_ui$Element$row,
			A2(
...
var $author$project$Page$Quest$List$topAppBar = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				A3(
				$author$project$Page$Quest$List$topAppBarRow,
				model.theme,
				_List_Nil,
				_List_fromArray(
					[
						$author$project$Page$Quest$List$input(model)
					])),
				A3(
				$author$project$Page$Quest$List$topAppBarRow,
				model.theme,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text('Quests'),
								A2(
								$mdgriffith$elm_ui$Element$el,
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$Font$size(13),
										$mdgriffith$elm_ui$Element$Font$color(
										A4($mdgriffith$elm_ui$Element$rgba255, 255, 255, 255, 0.76))
									]),
								$mdgriffith$elm_ui$Element$text(
									$elm$core$String$fromInt(
										$author$project$Page$Quest$List$questCompletionCount(model)) + '/1 completed today'))
							]))
					]))
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				model.menuOpen ? $mdgriffith$elm_ui$Element$Events$onClick($author$project$Page$Quest$List$MenuClosed) : $mdgriffith$elm_ui$Element$inFront($mdgriffith$elm_ui$Element$none)
			]),
		_List_fromArray(
			[
				...
				$author$project$Page$Quest$List$data(model))
			]));
};
...
var $author$project$Main$wrapper = F2(
